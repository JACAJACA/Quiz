...
function RegulationsScreen({ navigation }) {
    ...
    return (
        <View style={[styles.container]}>
            ...
            <ScrollView style={[styles.regulationsContainer]}>
                <Text style={[styles.regulationsText]}>
                    Sample Mobile App Terms and Conditions
                    Template
            ...
            <View style={[styles.footerContainer]}>
                <Text style={[styles.footerText]}>To continue, you must agree to terms and conditions.</Text>
                <TouchableOpacity onPress={acceptRegulations} style={[styles.acceptButton]}>
